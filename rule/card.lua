...
function Card:getSuitString(symbol)
  ...
  elseif suit == Card.Diamond then
    ret = "diamond"
  elseif suit == Card.NoSuit and self.color==Card.NoColor then
    ret = "nosuitnocolor"
  elseif suit == Card.NoSuit and self.color==Card.Black then
    ret = "nosuitblack"
  elseif suit == Card.NoSuitand and self.color==Card.Red then
    ret = "nosuitred"
  end
