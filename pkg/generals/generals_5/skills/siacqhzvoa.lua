...
["siacqhzvoa"] = "相咊",
[":siacqhzvoa"] = "伱末段始旹,伱可發動.伱選擇0至多其它脚色与伱成爲參與者,執行流程:伱占卜,參與者同旹選擇是否打出牌x大于0者.若无響應者,中止流程,否則響應者抽x+1且不再響應本次流程,若參與者皆已響應,停止流程參與者各抽1.",
-- [":siacqhzvoa"] = "伱末段始旹,伱可發動.伱占卜,若与此流程內上次占卜牌類別不同,伱可再次占卜.流程終止旹,伱選擇令1脚色抽x或回x/2",

["#siacqhzvoa-choose"] = "相咊 選擇多脚色入樂",
}
