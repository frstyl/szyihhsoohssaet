...
General:new(extension, "jiacqljim", "pujh", 5):addSkills{"tshjesthoeoms",}
Fk:loadTranslationTable{
["jiacqljim"] = "楊林",
["#jiacqljim"] = "錦豹子",
...
--樂娘子
General:new(extension, "caokhzvoa", "tsiacs", 3):addSkills {"tshjecqsziac","lihcaok" } --"mvoanqkoa" siacqhzvoa tshjecqsziac
Fk:loadTranslationTable{
["caokhzvoa"] = "樂和",
["#caokhzvoa"] = "鐵叫子",
