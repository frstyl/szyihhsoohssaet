...
--     if player:getMark("@minus_attack_range") >0 then
--       return   -player:getMark("@minus_attack_range")
--     end
--   end
-- })
...
--     return player==target and target:getMark("@minus_attack_range")>0
--   end,
--   on_refresh = function(self, event, target, player, data)
--     player.room:setPlayerMark(target,"@minus_attack_range",0)
--   end,
-- })
