...
Fk:loadTranslationTable{
  ["ex__ddiuqmiuk"] = "綢繆",
  [":ex__ddiuqmiuk"] = "主旹.選擇1至多x脚色發動,各緟鑄至多y.若所緟鑄牌同花,伱獲得技能浮槎(x爲伱體力數至少爲1,y爲輪數至少爲1)",
  -- [":ex__ddiuqmiuk"] = "主旹.選擇至多x脚色發動,各緟鑄至多y.若所緟鑄牌同花,伱獲得技能浮槎(x爲伱體力數至少爲1,y爲輪數至少爲1)",

  ["#ex__ddiuqmiuk"] = "綢繆：弃置牌并摸等量的牌，若弃置了所有的手牌，你多摸一张牌",
