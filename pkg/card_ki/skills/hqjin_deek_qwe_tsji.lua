...
skill:addTest(function(room, me)
  local hqjin_deek_qwe_tsji = Fk:cloneCard("hqjin_deek_qwe_tsji")
  FkTest.runInRoom(function()
    room.players[3]:drawCards(1)
  end)
  lu.assertIsTrue(table.every(room:getOtherPlayers(me, false), function (other)
    return not me:canUseTo(hqjin_deek_qwe_tsji, other)
  end))
  lu.assertIsTrue(me:canUseTo(hqjin_deek_qwe_tsji, room.players[3], {bypass_distances = true}))
