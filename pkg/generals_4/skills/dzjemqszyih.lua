local dzjemqszyih = fk.CreateSkill {
  name = "dzjemqszyih",
  tags = { Skill.Compulsory,Skill.Concealed },
}

Fk:loadTranslationTable{
  ["dzjemqszyih"] = "濳水",
  [":dzjemqszyih"] = "隱匿｡鎖定｡殺/鬥將/埋伏對伱生效前,若使用者攻程不大于其至伱距離,必發,此牌對伱无效",
...
dzjemqszyih:addEffect(fk.PreCardEffect, {
  can_trigger = function(self, event, target, player, data)
    ...
    and  table.contains({"ssaet", "mae_biuk","tous_tsiacs"}, data.card.trueName)
  end,
