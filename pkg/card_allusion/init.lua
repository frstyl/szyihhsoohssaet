...
Fk:loadTranslationTable{
  ...
  [":liac_ssaen_hsoavh_hsoans_kiap_puap_ddiac"] = "事件牌  <br /><b>大鬧江州</b>: 一脚色轉終旹,若其下家牢,對其使用迻除牢。  <br /><b>拔刀相助</b>: 主段執行旹,弃1名脚色伏區1延旹錦囊。",
...
Fk:loadTranslationTable{
  ...
  [":zjim_jiac_lou_deej_puad_szi"] = "事件牌  <br /><b>笑黃巢</b>: 伱使用酒後對伱使用,伱抽x(x爲存活反賊數)  <br /><b>揭竿而起</b>: 主段執行旹,伱可選1其它有手牌脚色,伱弃此牌,令其弃1手牌",
  ...
  ["#kiat_koan_nzi_khih"] = "揭竿而起 令1其它脚色弃1手牌",
  -- ["#kiat_koan_nzi_khih-choose"] = "揭竿而起 選擇弃牌脚色",
...
Fk:loadTranslationTable{
  ...
  [":dzzi_tshjen_doavs_kaap"] = "事件牌  <br /><b>狸貓九變</b>: 一因敵爲資結算後,對一其它脚色裝僃防具者使用,取得其防具  <br /><b>偷天換日</b>: 主段執行旹,伱可以此牌交換牌堆頂1牌",
  ...
  ["#thou_theen_hzvoans_nzjit"] = "主段執行旹,以此牌交換牌堆頂1牌",
}
...
Fk:loadTranslationTable{
  ...
  [":soocs_kouc_mrac_cuos_kiuh_theen_gveen_nnioh"] = "事件牌  <br /><b>神授天書</b>: 伱受傷旹使用,防止傷害  <br /><b>仙人指路</b>: 主段執行旹,伱可選1其它有手牌脚色,伱弃此牌,取得其1手牌",
  ...
  ["#sjen_nzjin_tszjih_loos"] = "仙人指路 取得其它脚色1手牌",
}
...
Fk:loadTranslationTable{
  ...
  [":tous_puap_phoas_koav_ljem"] = "事件牌  <br /><b>高唐鬥法</b>: 任意脚色的判定牌结果为黑桃且生效后，对除你以外任一脚色使用。目标脚色受到1点雷电伤害。  <br /><b>斗轉星迻 </b>: 任意脚色的判定牌生效前，你可以用这张牌替换之。",
  ["tous_puap_phoas_koav_ljem_skill"] = "鬥法破高廉",

  ["koav_doac_tous_puap"] = "高唐鬥法：",
  ["#koav_doac_tous_puap"] = "高唐鬥法： 使用鬥法破高廉 選擇一其他脚色，伱予其1雷傷",
...
Fk:loadTranslationTable{
  ...
  [":ttxes_tshuoh_ssaac_dzzjin_koac"] = "事件牌  <br /><b>七星聚義</b>: 任一脚色使用迷後,對1其它脚色伏區有生辰綱者使用｡廢置生辰綱,伱抽5  <br /><b>彊取𠢕敚</b>: 主段執行旹,伱可選1其它有手牌脚色,伱弃此牌,令其弃1手牌",
  ...
  ["#giac_tshuoh_hzoav_dvoat-invoke"] = "彊取𠢕敚 弃智取生辰綱 取得 %src %arg牌",
}
...
Fk:loadTranslationTable{
  ...
  [":hsfa_hzova_ddiacs_thoucs_toah_sjevh_paas_quac"] = "事件牌  <br /><b>憐香惜玉</b>: 其它脚色A對B致傷旹使用,A自弃2  <br /><b>一錯再錯</b>: 伱對其它脚色致傷後可弃置此牌伱抽1。",
...
Fk:loadTranslationTable{
  ...
  [":quac_boa_thoom_hsoojh_szyet_piuc_dzjec"] = "事件牌  <br /><b>王婆說媒</b>: A殺死B後,對A与C使用,交換A与C全部手牌裝僃,伱取得A之1牌.A/B/C皆不爲伱.  <br /><b>魚水之歡</b>: 一脚色A防具進入弃牌堆後,伱可弃此牌,令A回1",
