...
Fk:loadTranslationTable{
  ...
  ["ambush__ssaet"] = "伏殺",
  [":ambush__ssaet"] = "基本牌-行動  <br /><b>旹機</b>：主段執行旹  <br /><b>目幖</b>：其它脚色  <br /><b>目幖數</b>：1  <br /><b>距離</b>：伱攻程内  <br /><b>次數</b>：同名牌每段限1次  <br /><b>效果</b>：對目幖脚色造成1点傷害。  <br /><b>額外</b>：伏段執行旹,伱可使用葢伏之｢殺｣",
  -- ["ambush__ssaet"] = "伏殺",
  
  ["ambush__szjemh"] = "伏閃",
  [":ambush__szjemh"] = "基本牌-行動  <br /><b>旹機</b>:｢殺｣A對目幖生效前  <br /><b>目幖</b>:A  <br /><b>目幖數</b>：0  <br /><b>效果</b>：抵消A對目幖效果。  <br /><b>額外</b>：因動-抵消｡葢伏可用｡每旹機限1次｡全體脚色同旹選擇是否使用其葢伏之｢閃｣",

  ["ddxims__analeptic"] = "鴆酒",
  [":ddxims__analeptic"] = "基本牌-物資  <br /><b>旹機</b>主段執行旹  <br /><b>目幖</b>任意  <br /><b>目幖</b>：伱  <br /><b>效果</b>：目幖體力上限減至體力值,酒",

  ["thooms_theec"] = "探察",
  [":thooms_theec"] = "锦囊牌  <br /><b>旹機</b>:主段執行旹  <br /><b>目幖</b>：其它脚色  <br /><b>目幖數</b>：1  <br /><b>效果</b>：伱觀看其區域全部牌,肰後可展示其中1,若爲葢伏牌,伱弃置之",
  ["#thooms_theec"] = "选择1其它脚色，觀看其區域全部牌",

  ["mae_biuk"] = "埋伏",
  [":mae_biuk"] = "锦囊牌  <br /><b>旹機</b>:伏段執行旹  <br /><b>目幖</b>：其它脚色  <br /><b>目幖數</b>：1  <br /><b>距離</b>：伱至其距離1  <br /><b>效果</b>：目幖脚色需打出2閃,否則伱予其1傷。<br /><b>額外</b>：葢伏可用,否則不可用",
  ["#mae_biuk_skill"] = "选择1其它脚色，其需打出2閃,否則伱予其1傷",
  ["#mae_biuk_response"] = "%src 對伱使用 埋伏, 伱可打出閃  (當前第%arg, 總需 %arg2)",

  ["theem_prac_kaemh_tsoavs"] = "添兵減竈",  --添兵減竈theem_prac_kaemh_tsoavs 以退爲進 欲擒固縱 
  [":theem_prac_kaemh_tsoavs"] = "锦囊牌  <br /><b>旹機</b>:殺對伱生效歬  <br /><b>目幖</b>：无  <br /><b>目幖數</b>：0  <br /><b>效果</b>：抵消此殺對伱效果,殺使用者可對伱使用殺,若其未使用殺致傷,伱予其1傷。<br /><b>額外</b>：可且止可使用葢伏之｢添兵減竈｣",
  ...
  [":pik_dzziach_liac_ssaen"] = "锦囊牌  <br /><b>旹機</b>:主段執行旹  <br /><b>目幖</b>：其它脚色,伱与其(手牌-體力)不同號  <br /><b>目幖數</b>：1   <br /><b>效果</b>：目幖脚色流失1體力,弃2牌,抽3。",
  ["#pik_dzziach_liac_ssaen_skill"] = "选择1其它脚色，其流失1體力,弃2牌,抽3",
  ["#pik_dzziach_liac_ssaen_ask"] = "逼上梁山 弃2",

  ["tsiac_keejs_dzius_keejs"] = "將計就計",
  [":tsiac_keejs_dzius_keejs"] = "锦囊牌  <br /><b>旹機</b>錦囊牌A生效歬,A目幖數不大于1  <br /><b>目幖</b>A  <br /><b>目幖數</b>：0   <br /><b>效果</b>:抵消A,伱于A結算後獲得之  <br /><b>額外</b>：因動-抵消｡葢伏可用,否則不可用｡每旹機限1次,全體脚色同旹選擇是否使用其葢伏之｢將計就計｣",

  ["ambush__buac_hzfan_mujs_nzjen"] = "防患未肰",
  [":ambush__buac_hzfan_mujs_nzjen"] = "锦囊牌    <br /><b>旹機</b>：锦囊牌A生效前    <br /><b>目幖</b>：A    <br /><b>目幖數</b>：0  <br /><b>效果</b>：抵消A效果      <br /><b>額外</b>：因動-抵消｡葢伏可用｡每旹機限1次,全體脚色同旹選擇是否使用其葢伏之｢防患未肰｣",
  ...
  ["djis_douch"] = "地動",
  [":djis_douch"] = "法術-天災<br/><b>旹機</b>：主段執行旹  <br /><b>目幖</b>：任意  <br /><b>目幖數</b>：伱  <br /><b>延旹</b>：將此牌置于目幖脚色伏區,目幖伏段執行旹生效<br/><b>效果</b>：目幖判定,若:花色爲♥️,其弃置全部裝僃,受x傷(x爲所弃裝僃數);否則將此牌至入下家伏區  <br /><b>額外</b>：此牌被抵消後至入目幖下家伏區",
  ["#hsoo_piuc_hsvoans_quoh_skill"] = "呼風喚雨",

  ["hsoeojh_seevs"] = "海嘯",
  [":hsoeojh_seevs"] = "法術-天災  <br /><b>旹機</b>：主段執行旹  <br /><b>目幖</b>：任意  <br /><b>目幖數</b>：伱  <br /><b>延旹</b>：將此牌置于目幖脚色伏區,目幖伏段執行旹生效  <br /><b>生效</b>：目幖A判定阶段判定生效,A判定,若結果爲黑色AJQK,A弃全部牌,;否則將此牌至入下家伏區  <br /><b>額外</b>：此牌被抵消後至入目幖下家伏區",

  ["tsjek_tshoavh_doon_liac"] = "積艸屯糧",
  [":tsjek_tshoavh_doon_liac"] = "锦囊牌  <br/><b>旹機</b>:主段執行旹  <br/><b>目幖</b>：任意  <br /><b>目幖數</b>：1  <br /><b>延旹</b>：將此牌置于目幖脚色伏區,目幖伏段執行旹生效<br/><b>效果</b>：目幖判定：若判定牌非虛,A獲得判定牌.除非若判定牌存在且爲♦️，否則跳过A的弃牌阶段。",
