...
-- extension:loadSkillSkelsByPath("./packages/szyihhsoohssaet/pkg/cards/card_Ex/skills")
...
extension:addCardSpec("thoeoms_tsshaet", Card.Club, 4)

extension:addCardSpec("hqjin_szjer_ljis_doavs", Card.Spade, 11)
extension:addCardSpec("hqjin_szjer_ljis_doavs", Card.Club, 10)  --?殺

extension:addCardSpec("dou_dook", Card.Spade, 5)
extension:addCardSpec("dou_dook", Card.Heart, 5)
