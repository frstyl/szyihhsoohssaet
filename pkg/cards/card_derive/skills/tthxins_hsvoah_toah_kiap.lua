...
[":tthxins_hsvoah_toah_kiap_skill"] = "其它脚色受傷後,若其有牌,伱可對其起動｡伱取得其1牌.",

["#tthxins_hsvoah_toah_kiap_skill-invoke"] = "趁火打劫 取得 %src 手牌",
}
...
cardSkill:addEffect(fk.Damaged, {  --合并諸牌  --于時機問牌skill占卜是否可用 用牌前前調用牌処理相關
  -- global = true,
  -- mute = true,
  priority = 0.001, 
