...
skill:addEffect("cardskill", {
  interaction = function(self, player, card, extra_data)
  ...
  prompt = function(self, player, selected_cards)
    local ssaet = Fk:cloneCard("ambush__ssaet")
    ...
    return max_num > 1 and "#ambush__ssaet_skill_multi:::" .. max_num or "#ambush__ssaet_skill"
  end,
