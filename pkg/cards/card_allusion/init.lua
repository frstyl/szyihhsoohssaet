...
extension:loadSkillSkelsByPath("./packages/szyihhsoohssaet/pkg/cards/card_allusion/skills")
...
Fk:loadTranslationTable{
  ...
  ["#sjevs_hzvoac_dzaav"] = "笑黃巢 起動潯陽樓提反䛐 抽%arg",
...
Fk:loadTranslationTable{
  ...
  ["#zzjin_dzzius_theen_szio"] = "神授天書 起動宋公明遇九天玄女 防止傷害",
...
Fk:loadTranslationTable{
  ...
  ["#leen_hsiac_sjek_ciok"] = "憐香惜玉： 起動 花和尙痛打小霸王 令 %src 弃2",
