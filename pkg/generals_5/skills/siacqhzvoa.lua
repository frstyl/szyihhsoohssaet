...
["siacqhzvoa"] = "相咊",
[":siacqhzvoa"] = "末段始旹,伱可發動.伱選擇任意數量其它脚色与伱成爲參與者,執行流程:伱判定,參與者同旹選擇是否打出牌x大于0者.若无響應者,中止流程,否則響應者抽x+1且不再響應本次流程,若參與者皆已響應,停止流程參與者各抽1.",
-- [":siacqhzvoa"] = "末段始旹,伱可發動.伱判定,若与此流程內上次判定牌類別不同,伱可再次判定.流程終止旹,伱選擇令1脚色抽x或回x/2",

["#siacqhzvoa-choose"] = "相咊 選擇任意脚色入樂",
}
